      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <p className="footer-desc">
              Kebersihan dan kenyamanan untuk gaya hidup modern Anda. Solusi
              laundry terpercaya keluarga Indonesia.
            </p>
            <div className="social-links">
              <a
                href="https://wa.me/6285181840082"
        ...
        <div className="footer-bottom">
          <span className="copyright">
            &copy; 2024 Central Laundry Express. Hygiene & Convenience.
          </span>
          <button
            onClick={scrollToTop}
            style={{
